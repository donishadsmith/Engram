...
fn test_interrupt_timing() {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("tests/gb-test-roms/interrupt_time/interrupt_time.gb");
...
fn test_mem_timing() {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("tests/gb-test-roms/mem_timing/mem_timing.gb");
...
fn test_mem_timing2() {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("tests/gb-test-roms/mem_timing-2/mem_timing.gb");
...
fn test_oam_bug() {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("tests/gb-test-roms/oam_bug/oam_bug.gb");
...
fn test_halt_bug() {
    let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("tests/gb-test-roms/halt_bug.gb");
