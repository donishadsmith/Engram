...
A Gameboy Advance (RTC, APU [only mono fifo and pulse-based music], and some other PPU features still needs to be implemented) & Game Boy Color emulator (supports DMG games too) written in Rust.
